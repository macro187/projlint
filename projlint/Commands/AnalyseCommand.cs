...
public static int
Analyse(RepositoryContext repository, Queue<string> args)
{
    bool success = true;
...
static bool
AnalyseRepositoryAspects(RepositoryContext repository)
{
    bool success = true;
...
static bool
AnalyseProjectAspects(RepositoryContext repository)
{
    bool success = true;
