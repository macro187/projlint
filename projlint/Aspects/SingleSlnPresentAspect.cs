...
{
    public class SingleSlnPresentAspect : RepositoryAspect
    {

        public SingleSlnPresentAspect(RepositoryContext context)
            : base(context)
        {
            correctSlnName = SlnNameCorrectAspect.GetCorrectSlnName(context);
        }
